...
const SingleProduct = () => {
  ...
  return (
    <>
            ...
            <div className="col-lg-6 col-md-6 col-12">
              <div className="main-product-details">
                ...
                <div className="borderBottom2">
                  ...
                  <div className="d-flex d-lg-flex align-items-center gap-10">
                    <ReactStars
                      count={5}
                ...
                <div className="borderBottom3 py-4">
                  ...
                  <div className="d-lg-flex  gap-10 flex-row align-items-center">
                    <h3>Quantity :</h3>
                    <div>
                      <input
                        type="number"
                    ...
                    <div className="d-md-flex mobile-btn-gap align-items-center gap-15">
      ...
      {/* you May Also Like */}
      <section className="popular_wrapper py-2 home-wrapper-2">
        <div className="container-xl">
          <div className="row">
            <div className="col-12">
